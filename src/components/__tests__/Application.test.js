...
import { render, cleanup, waitForElement, fireEvent, getAllByTestId, getByAltText, getByPlaceholderText, queryByText, queryByAltText, prettyDOM } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("loads data, edits an interview and  spots remaining the same for Monday", async () => {
    // 1. Render the Application.
    const { container } = render(<Application />);
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    // 7. Check that the element with the text "Could not create appointment" is displayed.
    await waitForElement(() => queryByText(appointment, "Could not create appointment"));
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    // 6. Check that the element with the text "Could not create appointment" is displayed.
